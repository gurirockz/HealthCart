...
import {View, Text, TouchableOpacity, Image, StyleSheet, statusBarTransition, StatusBar, hidden, statusBarStyle, TextInput, number, Pressable} from 'react-native';
      ...
      <View
        ...
        <View style={{flexDirection: 'row-reverse'}}>
          <Image
            ...
            style={{width: 120, height: 25, marginTop: -28}}></Image>
        </View>
       <Text style={{textAlign: 'center', marginTop: 50}}>Enter 4 digit OTP</Text>
